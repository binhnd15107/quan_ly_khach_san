                ...
                <div class="row mb-4">
                    <div class="col-lg-12">
                        <ol class="breadcrumb text-muted fs-6 fw-bold">
                            ...
                            <li class="breadcrumb-item px-3 text-muted">Cập nhật banner </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="review-tab-pro-inner">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <form action="{{ route('admin.banner.edit', $data->id) }}" method="post"
                                        ...
                                        <div class="review-content-section">
                                            ...
                                            <div>
                                                <img id="show"
                                                    src="{{ asset('assets/img/' . $data->image) ?? 'https://ap.poly.edu.vn/images/Banner-AP.png' }}">
                                            </div>
                                            <br>
                                            @error('image')
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <select data-hide-search="false" name="bannerable_id"
                                                            ...
                                                            <option
                                                                {{ $data->bannerable_id == config('util.BANNER_DB') ? 'selected' : '' }}
                                                                value="1">
                                                                Trang chủ
                                                            </option>
                                                            <option
                                                                {{ $data->bannerable_id == config('util.BANNER_ROOM') ? 'selected' : '' }}
                                                                value="2">
                                                                Trang phòng
                                                            </option>
                                                            <option
                                                                {{ $data->bannerable_id == config('util.BANNER_POST') ? 'selected' : '' }}
                                                                value="3">
                                                                Trang bài viết
                                                            </option>
                                                        </select>
