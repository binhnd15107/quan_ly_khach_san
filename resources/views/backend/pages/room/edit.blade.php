                ...
                <div class="row mb-4">
                    <div class="col-lg-12">
                        <ol class="breadcrumb text-muted fs-6 fw-bold">
                            ...
                            <li class="breadcrumb-item px-3 text-muted">Cập nhật phòng </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="review-tab-pro-inner">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <form action="{{ route('admin.room.edit', $data->id) }}" method="post"
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <select data-hide-search="false" name="type_room_id"
                                                            ...
                                                            @foreach ($typeRooms as $item)
                                                                <option
                                                                    {{ $data->type_room_id == $item->id ? 'selected' : '' }}
                                                                    value="{{ $item->id }}">
                                                                    {{ $item->name }}
                                                                </option>
                                                            @endforeach
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input value="{{ $data->images }}" class="form-control"
                                                            type="file" id="files" name="images[]" multiple />
                                                        <br>
                                                        @if ($data->images != null)
                                                            @foreach (json_decode($data->images, true) as $item)
                                                                <span class="pip">
                                                                    <img class="imageThumb"
                                                                        src="{{ asset('assets/img/' . $item) }}"
                                                                        title="" />
