...
@section('title', 'Danh sách phòng đã xóa')
@section('page-title', 'Danh sách phòng đã xóa')
@section('content')
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12">
                                <ol class="breadcrumb text-muted fs-6 fw-bold">
                                    ...
                                    <li class="breadcrumb-item px-3 text-muted">Các phòng đã xóa </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button data-toggle="tooltip" title="Khôi phục" class="pd-setting-ed">
                                                <a href="{{ route('admin.room.soft.backup', $item->id) }}"><i
