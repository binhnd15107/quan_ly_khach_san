...
@section('page-title', 'Cập nhật loại phòng')
@section('page-css')
    <style>
                ...
                <div class="row mb-4">
                    <div class="col-lg-12">
                        <ol class="breadcrumb text-muted fs-6 fw-bold">
                            ...
                            <li class="breadcrumb-item px-3 text-muted">Cập nhật loại phòng </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="review-tab-pro-inner">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <form action="{{ route('admin.typeroom.edit', $data->id) }}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
