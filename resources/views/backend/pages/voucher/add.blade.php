                ...
                <div class="row mb-4">
                    <div class="col-lg-12">
                        <ol class="breadcrumb text-muted fs-6 fw-bold">
                            ...
                            <li class="breadcrumb-item px-3 text-muted">Thêm mới voucher </li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="review-tab-pro-inner">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <form action="{{ route('admin.voucher.add') }}" method="post"
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <select data-hide-search="false" name="limit[]"
                                                            ...
                                                            @foreach ($dataRoom as $item)
                                                                <option
                                                                    {{ collect(old('limit'))->contains($item->id) ? 'selected' : '' }}
                                                                    value="{{ $item->id }}">
                                                                    {{ $item->name }}
                                                                </option>
                                                            @endforeach
