    ...
    <div id="invoiceholder">
        <div id="invoice" class="effect2">
            ...
            @if ($mailData['bill'] != null)
                ...
                <div id="invoice-mid">
                    <div id="message">
                        <h2>Cảm ơn {{ $mailData['bill']->uName }} đã sử dụng dịch vụ của chúng tôi</h2>
                            ...
                            <div class="clientinfo">
                                ...
                                <div class="cta-group">
                                    @if ($mailData['bill']->pay_status == 0)
                                        <a class="btn-primary">Chưa thanh toán</a>
                                    @else
                                        <a class="btn-primary">Đã thanh toán</a>
                                    @endif
                                    {{-- <a href="javascript:void(0);" class="btn-default">Reject</a> --}}
                                </div>
                            </div>
                ...
                <div id="invoice-bot">
                    <div id="table">
                        <table class="table bill_sevices_table">
                            ...
                            <tbody>
                                ...
                                @else
                                    <p style="color: black;padding:10px"> Không tìm thấy
                                        phòng</p>
                                @endif
                    ...
                    <a class="btn-primary">Tổng thanh toán : {{ number_format($mailData['bill']->total_money) }}
                        Vnđ</a>
                    <br>
                    <h3>Stk: 1013347788 </h3>
                    <h3>Ngân hàng : Vietcomback</h3>
                </div>
            @endif
            <!--End InvoiceBot-->
            <footer>
